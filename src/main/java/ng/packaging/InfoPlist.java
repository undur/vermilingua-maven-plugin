...
public class InfoPlist {
	 ...
	 */
	public static String make( final SourceProject sourceProject, final String applicationName, final String version, final String mainJarFileName ) {
		final var type = sourceProject.type();
