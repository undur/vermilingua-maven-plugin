...
public class InfoPlist {
	 ...
	 * Unfortunately, WO/Wonder currently reads the Info.plist and actually uses some of it's values.
	 ...
	 */
	public static String make( final SourceProject sourceProject, final String principalJarFilename ) {
		...
		infoPlist.put( "NSJavaPath", List.of( principalJarFilename ) );
		infoPlist.put( "NSJavaPathClient", principalJarFilename );
